...
class AchievementTest(unittest.TestCase):
    ...
    def record_actions(self, player, action_name, count):
    ...
    def test_action_count_unlocks_at_threshold(self):
        ...
        player = FakePlayer()
        self.record_actions(player, "学习", 20)
    ...
    def test_achievement_system_uses_unlockable_base(self):
        self.write_achievements([])
        player = FakePlayer()

        system = AchievementSystem(player)

        self.assertIsInstance(system, UnlockableSystem)
        self.assertEqual(system.achievements, [])
    ...
    def test_action_count_does_not_unlock_before_threshold(self):
        ...
        player = FakePlayer()
        self.record_actions(player, "学习", 19)
    ...
    def test_unlocked_achievement_does_not_reward_again(self):
        ...
        player = FakePlayer()
        self.record_actions(player, "学习", 20)
        unlock_achievement(player, "study_20")
