...
class GameUI:
    def __init__(self):
        ...
        self.special_task_button = tk.Button(
            self.special_task_frame,
            text=self.get_special_task_button_text(),
            command=self.handle_special_task
        )
        self.special_task_button.pack()
    ...
    def get_special_task_button_text(self):
        task = self.special_task_manager.task
    ...
    def handle_special_task(self):
        task = self.special_task_manager.task

        if task is None:
            return

        coin, exp = self.special_task_manager.finish_task()
    ...
    def update_display(self):
        ...
        self.special_task_button.config(
            text=self.get_special_task_button_text()
        )
